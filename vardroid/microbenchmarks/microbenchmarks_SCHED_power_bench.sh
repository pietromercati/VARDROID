...
rm ./SCHED_power*
rm ./MICORBENCHMARKS_RESULTS/SCHED_power_bench/*
...
do
	...
	./${test_dir}/test_1_long 5 > execution_time_SCHED_power_${sched_ID}_${sleep_length}	
...
mv SCHED_power_* ./MICROBENCHMARKS_RESULTS/SCHED_power_bench/
mv SCHED_random ./MICROBENCHMARKS_RESULTS/SCHED_power_bench/
mv execution_time_SCHED_power_* ./MICROBENCHMARKS_RESULTS/SCHED_power_bench/
